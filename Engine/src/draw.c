...
void vlineasm4(int32_t columnIndex, int32_t framebuffer, int32_t *buffer, int32_t *vplce)
{
...
void mvlineasm4(int32_t column, int32_t framebufferOffset, int32_t *buffer, int32_t *vplce)
{
    int i;
    uint32_t temp;
