...
int loadplayer(int8_t spot)
{
    ...
    for (int i=0; i<MAXSECTORS; i++) {
        ...
        sector[i].ceiling.flags    = *(SectorFlags *)&sector_on_grp[i].ceilingstat;
        ...
        sector[i].floor.flags    = *(SectorFlags *)&sector_on_grp[i].floorstat;
...
// CTW END - MODIFICATION
        ...
        case 700:
            ...
            if (SoundToggle && FXDevice != NumSoundCards) {
                menutext(c+160+40,43,0,(FXDevice == NumSoundCards),"ON");
            } else {
                menutext(c+160+40,43,0,(FXDevice == NumSoundCards),"OFF");
            }
            ...
            if (MusicToggle && (MusicDevice != NumSoundCards) && (!eightytwofifty||numplayers<2)) {
                ...
                menutext(c+160+40,43+16,0,(MusicDevice == NumSoundCards),"OFF");
            }
            ...
            if (VoiceToggle) {
                menutext(c+160+40,43+16+16+16+16,0,(FXDevice==NumSoundCards)||SoundToggle==0,"ON");
            } else {
                menutext(c+160+40,43+16+16+16+16,0,(FXDevice==NumSoundCards)||SoundToggle==0,"OFF");
            }

            if (AmbienceToggle) {
                menutext(c+160+40,43+16+16+16+16+16,0,(FXDevice==NumSoundCards)||SoundToggle==0,"ON");
            } else {
                menutext(c+160+40,43+16+16+16+16+16,0,(FXDevice==NumSoundCards)||SoundToggle==0,"OFF");
            }

            if (ReverseStereo) {
                menutext(c+160+40,43+16+16+16+16+16+16,0,(FXDevice==NumSoundCards)||SoundToggle==0,"ON");
            } else {
                menutext(c+160+40,43+16+16+16+16+16+16,0,(FXDevice==NumSoundCards)||SoundToggle==0,"OFF");
            }

            menutext(c,43+16+16+16+16+16+16+16,SHX(-9),(FXDevice==NumSoundCards)||SoundToggle==0,"OPPONENT SOUND");
            if (OpponentSoundToggle) {
                menutext(c+160+40,43+16+16+16+16+16+16+16,0,(FXDevice==NumSoundCards)||SoundToggle==0,"ON");
            } else {
                menutext(c+160+40,43+16+16+16+16+16+16+16,0,(FXDevice==NumSoundCards)||SoundToggle==0,"OFF");
            }
